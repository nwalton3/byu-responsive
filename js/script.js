...
$(function() {
  startWidth = getCookie('screenwidth'); // This is the width of the screen the last time the user visited
  w = $(window).width(); // Current screen width
  
  log('Cookie width: ' + startWidth);
  log('Current screen width: ' + w);
  ...
  // 300px
  enquire.register("screen and (min-width:" + sm + "px)", {
      match : function() {},
      //unmatch : function() {},
      setup : function() {
        adjustSm();
  ...
  .register("screen and (min-width:" + md + "px)", {
      match : function() {},
      //unmatch : function() {},
      setup : function() {
        adjustMd();
  ...
  .register("screen and (min-width:" + lg + "px)", {
      match : function() {},
      //unmatch : function() {},
      setup : function() {
        adjustLg();
...
/*
  .register("screen and (min-width:" + xl + "px)", {
      match : function() {},
      //unmatch : function() {},
      setup : function() {
        adjustXl();
